...
export const OnboardingDisclaimer = () => {
  const onSubmitOnboardingDisclaimer: (
  ...
  return (
    <View className="flex-1 justify-center p-4">
      ...
      <SafeAreaView className="mt-6">
        ...
        <Text variant="lg" style={{ marginTop: paraMargin }}>
          In completing our mini-games, you are encouraged to explore and
          interact with your surroundings.
        </Text>
        <Text variant="lg" style={{ marginTop: paraMargin }}>
          We want to make sure that you experience RunSquad in a safe and
          responsible way.
        </Text>
        <Text variant="lg" style={{ marginTop: paraMargin }}>
          In using RunSquad, you always agree to observe personal safety and
